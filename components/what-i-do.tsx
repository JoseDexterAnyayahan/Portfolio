...
const services = [
  {
    ...
    gradient:
      "group-hover:bg-gradient-to-br group-hover:from-purple-600/20 group-hover:to-violet-600/5",
  },
  {
    title: "Videography",
    description:
    ...
    gradient:
      "group-hover:bg-gradient-to-br group-hover:from-violet-600/20 group-hover:to-purple-600/5",
  },
  {
    title: "Photography",
    description:
    ...
    gradient:
      "group-hover:bg-gradient-to-br group-hover:from-purple-600/20 group-hover:to-fuchsia-600/5",
  },
  {
    ...
    gradient:
      "group-hover:bg-gradient-to-br group-hover:from-fuchsia-600/20 group-hover:to-purple-600/5",
  },
  {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div
                  className={`absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r ${service.color}`}
                />
                <div
                  className={`absolute inset-y-0 right-0 w-[2px] bg-gradient-to-b ${service.color} opacity-50`}
                />
              </div>
              ...
              <CardContent className="p-7 relative z-10">
                ...
                <div className="relative mb-5 inline-block">
                  {/* Glow ring */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${service.color} rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition-all duration-500 scale-150`}
                  />
